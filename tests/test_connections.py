...
print("PyKos version:", pykos.__version__)
...
all_actuators = [{"actuator_id": id, "position": 10} for id in range(1, 10)]
kos.actuator.command_actuators(all_actuators)
print("All joints set to position 0.")
